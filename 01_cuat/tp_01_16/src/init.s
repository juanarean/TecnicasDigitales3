...
EXTERN ___tarea3_vma_st
EXTERN ___tarea3_lma_st
EXTERN ___tarea3_size
EXTERN ___tarea4_vma_st
EXTERN ___tarea4_lma_st
EXTERN ___tarea4_size
...
EXTERN ___bss_tarea3_vma
EXTERN ___datos_tarea3_vma
EXTERN ___bss_tarea4_vma
EXTERN ___datos_tarea4_vma
...
%define ATTR_SUP 0x00000003
%define ATTR_USU 0x00000007
...
kernel32_init:
   ...
   ;Desempaquetar tarea3
   push ebp
   mov ebp, esp
   push ___tarea3_size
   push 0x00541000
   push ___tarea3_lma_st
   call __fast_memcpy
   leave
   cmp eax, 1           ;Analizo el valor de retorno (1 Exito -1 Fallo)
   jne .guard
   
   ;Desempaquetar tarea4
   push ebp
   mov ebp, esp
   push ___tarea4_size
   push 0x00551000
   push ___tarea4_lma_st
   call __fast_memcpy
   leave
   cmp eax, 1           ;Analizo el valor de retorno (1 Exito -1 Fallo)
   jne .guard
...
;-----------------------------------------------------------------------
; Arbol de directorios para la tarea 0
    inc eax
    shl eax,12
    add eax,__PDPT
    mov [__PDPT0],eax
    ...
    mov eax, [__PDPT0]
    push eax
    mov eax,0x1fff8000 ;pagina pila PL0
    push eax
    mov eax,__STACK_START_T_PL0 ;pagina pila PL0
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT0]
    push eax
    mov eax, 0x1fffc000 ;pila pl3
    push eax
    mov eax, __STACK_START_T_PL3
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT0]
    push eax
    mov eax, 0x00501000  ;pagina tarea 0
    push eax
    ...
    mov eax, [__PDPT0]
    push eax
    mov eax, 0x00502000  ;pagina tarea 1 datos no inic
    push eax
    ...
    mov eax, [__PDPT0]
    push eax
    mov eax, 0x00503000  ;pagina tarea 1 datos inic
    push eax
...
; Arbol de directorios para la tarea 1
    ...
    mov eax, [__PDPT1]
    push eax
    mov eax,0x1fffa000  ;pagina pila
    push eax
    mov eax,__STACK_START_T_PL0  ;pagina pila pl0
    push eax
    call __paginacion
    ...
    mov eax, [__PDPT1]
    push eax
    mov eax,0x1fffe000  ;pagina pila
    push eax
    mov eax,__STACK_START_T_PL3  ;pagina pila pl3
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT1]
    push eax
    mov eax, 0x00521000  ;pagina tarea 1
    push eax
    ...
    mov eax, [__PDPT1]
    push eax
    mov eax, 0x00522000  ;pagina tarea 1 datos no inic
    push eax
    ...
    mov eax, [__PDPT1]
    push eax
    mov eax, 0x00523000  ;pagina tarea 1 datos inic
    push eax
...
;Arbol de directorios para la tarea 2
    ...
    mov eax, [__PDPT2]
    push eax
    mov eax,0x1fff9000  ;pagina pila pl0
    push eax
    mov eax,__STACK_START_T_PL0
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT2]
    push eax
    mov eax,0x1fffd000  ;pagina pila pl3
    push eax
    mov eax,__STACK_START_T_PL3
    push eax
    call __paginacion
    ...
    mov eax, [__PDPT2]
    push eax
    mov eax, 0x00531000  ;pagina tarea 2
    push eax
    ...
    mov eax, [__PDPT2]
    push eax
    mov eax, 0x00532000  ;pagina tarea 2 datos no inic
    push eax
    ...
    mov eax, [__PDPT2]
    push eax
    mov eax, 0x00533000  ;pagina tarea 2 datos inic
    push eax
...
;----------------------------------------------------------------
;Arbol de directorios para la tarea 3
    inc eax
    shl eax,12
    add eax,[__PDPT2]
    mov [__PDPT3],eax
    ...
    mov eax, [__PDPT3]
    push eax
    mov eax,0x1ff01000  ;pagina pila pl0
    push eax
    mov eax,__STACK_START_T_PL0
    push eax
    call __paginacion
    ...
    mov eax, [__PDPT3]
    push eax
    mov eax,0x1ff0e000  ;pagina pila pl3
    push eax
    mov eax,__STACK_START_T_PL3
    push eax
    call __paginacion
    ...
    mov eax, [__PDPT3]
    push eax
    mov eax, 0x00541000  ;pagina tarea 2
    push eax
    mov eax, ___tarea3_vma_st
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT3]
    push eax
    mov eax, 0x00542000  ;pagina tarea 2 datos no inic
    push eax
    mov eax, ___bss_tarea3_vma
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT3]
    push eax
    mov eax, 0x00543000  ;pagina tarea 2 datos inic
    push eax
    mov eax, ___datos_tarea3_vma
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
...
;Arbol de directorios para la tarea 4
    ...
    mov eax, [__PDPT4]
    push eax
    mov eax,0x1ff02000  ;pagina pila pl0
    push eax
    mov eax,__STACK_START_T_PL0
    push eax
    call __paginacion
    ...
    mov eax, [__PDPT4]
    push eax
    mov eax,0x1ff0f000  ;pagina pila pl3
    push eax
    mov eax,__STACK_START_T_PL3
    push eax
    call __paginacion
    ...
    mov eax, [__PDPT4]
    push eax
    mov eax, 0x00551000  ;pagina tarea 2
    push eax
    mov eax, ___tarea4_vma_st
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT4]
    push eax
    mov eax, 0x00552000  ;pagina tarea 2 datos no inic
    push eax
    mov eax, ___bss_tarea4_vma
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
    ...
    mov eax, [__PDPT4]
    push eax
    mov eax, 0x00553000  ;pagina tarea 2 datos inic
    push eax
    mov eax, ___datos_tarea4_vma
    push eax
    call __paginacion
    add esp,4*4         ;restablesco el puntero de pila porque el c no lo hace
...
; Inicializo TSS.
     ...
     mov dword [tss_tarea3+OFFSET_BACKLINK], __tarea3
     mov dword [tss_tarea4+OFFSET_BACKLINK], __tarea4
     mov dword [tss_tarea0+OFFSET_ESP0], __STACK_START_T_PL0 + 0x1000
     mov dword [tss_tarea0+OFFSET_SS0], DATA_SEL
     mov dword [tss_tarea1+OFFSET_ESP0], __STACK_START_T_PL0 + 0x1000
     mov dword [tss_tarea1+OFFSET_SS0], DATA_SEL
     mov dword [tss_tarea2+OFFSET_ESP0], __STACK_START_T_PL0 + 0x1000
     mov dword [tss_tarea2+OFFSET_SS0], DATA_SEL
     mov dword [tss_tarea3+OFFSET_ESP0], __STACK_START_T_PL0 + 0x1000
     mov dword [tss_tarea3+OFFSET_SS0], DATA_SEL
     mov dword [tss_tarea4+OFFSET_ESP0], __STACK_START_T_PL0 + 0x1000
     mov dword [tss_tarea4+OFFSET_SS0], DATA_SEL
     mov dword [tss_tarea0+OFFSET_ESP], __STACK_START_T_PL0 + 0x1000
     mov dword [tss_tarea1+OFFSET_ESP], __STACK_START_T_PL3 + 0x1000
     mov dword [tss_tarea2+OFFSET_ESP], __STACK_START_T_PL3 + 0x1000
     mov dword [tss_tarea3+OFFSET_ESP], __STACK_START_T_PL3 + 0x1000
     mov dword [tss_tarea4+OFFSET_ESP], __STACK_START_T_PL3 + 0x1000
     mov dword [tss_tarea0+OFFSET_EIP], __tarea0
     mov dword [tss_tarea0+OFFSET_CS], CODE_SEL
     mov dword [tss_tarea1+OFFSET_EIP], __tarea1
     mov dword [tss_tarea1+OFFSET_CS], CODE_SEL_PL3
     mov dword [tss_tarea2+OFFSET_EIP], __tarea2
     mov dword [tss_tarea2+OFFSET_CS], CODE_SEL_PL3
     mov dword [tss_tarea3+OFFSET_EIP], __tarea3
     mov dword [tss_tarea3+OFFSET_CS], CODE_SEL_PL3
     mov dword [tss_tarea4+OFFSET_EIP], __tarea4
     mov dword [tss_tarea4+OFFSET_CS], CODE_SEL_PL3
     mov dword [tss_tarea0+OFFSET_DS], DATA_SEL
     mov dword [tss_tarea1+OFFSET_DS], DATA_SEL_PL3
     mov dword [tss_tarea2+OFFSET_DS], DATA_SEL_PL3
     mov dword [tss_tarea3+OFFSET_DS], DATA_SEL_PL3
     mov dword [tss_tarea4+OFFSET_DS], DATA_SEL_PL3
     mov dword [tss_tarea0+OFFSET_ES], DATA_SEL
     mov dword [tss_tarea1+OFFSET_ES], DATA_SEL_PL3
     mov dword [tss_tarea2+OFFSET_ES], DATA_SEL_PL3
     mov dword [tss_tarea3+OFFSET_ES], DATA_SEL_PL3
     mov dword [tss_tarea4+OFFSET_ES], DATA_SEL_PL3
     mov dword [tss_tarea0+OFFSET_FS], DATA_SEL
     mov dword [tss_tarea1+OFFSET_FS], DATA_SEL_PL3
     mov dword [tss_tarea2+OFFSET_FS], DATA_SEL_PL3
     mov dword [tss_tarea3+OFFSET_FS], DATA_SEL_PL3
     mov dword [tss_tarea4+OFFSET_FS], DATA_SEL_PL3
     mov dword [tss_tarea0+OFFSET_GS], DATA_SEL
     mov dword [tss_tarea1+OFFSET_GS], DATA_SEL_PL3
     mov dword [tss_tarea2+OFFSET_GS], DATA_SEL_PL3
     mov dword [tss_tarea3+OFFSET_GS], DATA_SEL_PL3
     mov dword [tss_tarea4+OFFSET_GS], DATA_SEL_PL3
     mov dword [tss_tarea0+OFFSET_SS], DATA_SEL
     mov dword [tss_tarea1+OFFSET_SS], DATA_SEL_PL3
     mov dword [tss_tarea2+OFFSET_SS], DATA_SEL_PL3
     mov dword [tss_tarea3+OFFSET_SS], DATA_SEL_PL3
     mov dword [tss_tarea4+OFFSET_SS], DATA_SEL_PL3
     ...
     mov dword [tss_tarea3+OFFSET_EFLAGS], 0x200    
     mov dword [tss_tarea4+OFFSET_EFLAGS], 0x200 
