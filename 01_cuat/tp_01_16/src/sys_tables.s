...
GLOBAL SEL_TSS_TAREA3
GLOBAL SEL_TSS_TAREA4
GLOBAL _mmxt0
GLOBAL _mmxt1
GLOBAL _mmxt2
GLOBAL _mmxt3
...
;-----------------------------------------------------------------------------------------------------------
; TSS tarea 3
tss_tarea3 times LONG_TSS db 0    ;TSS tarea 3

;-----------------------------------------------------------------------------------------------------------
; TSS tarea 4
tss_tarea4 times LONG_TSS db 0    ;TSS tarea 4
...
_mmxt3 times LONG_MMX db 0

_mmxt4 times LONG_MMX db 0
...
base_tss0_0_15:     dw LONG_TSS         ;.sys_tables + tamaño de la TSS0
...
SEL_TSS_TAREA1 equ $ - GDT
                    dw LONG_TSS-1      ;Descriptor de TSS desocupado (tarea 1) 
base_tss1_0_15:     dw LONG_TSS * 2        ;.sys_tables + tamaño de la TSS0
...
base_tss2_0_15:     dw LONG_TSS * 3     ;.sys_tables + tamaño TSS0 + tamaño TSS1
base_tss2_16_23:    db 0x10
                    db 0x89
                    db 0x00
base_tss2_24_31:    db 0x00
;******************************************/
SEL_TSS_TAREA3 equ $ - GDT
                    dw LONG_TSS-1      ;Descriptor de TSS desocupado (tarea 2) 
base_tss3_0_15:     dw LONG_TSS * 4     ;.sys_tables + tamaño TSS0 + tamaño TSS1
base_tss3_16_23:    db 0x10
                    db 0x89
                    db 0x00
base_tss3_24_31:    db 0x00
;******************************************/
SEL_TSS_TAREA4 equ $ - GDT
                    dw LONG_TSS-1      ;Descriptor de TSS desocupado (tarea 2) 
base_tss4_0_15:     dw LONG_TSS * 5     ;.sys_tables + tamaño TSS0 + tamaño TSS1
base_tss4_16_23:    db 0x10
                    db 0x89
                    db 0x00
base_tss4_24_31:    db 0x00
;******************************************/
CODE_SEL_PL3    equ     $ - GDT + 3
dw	0xffff
dw	0x0000
db	0x00
db	11111011b
